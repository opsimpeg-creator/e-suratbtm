...
export const DEMO_SAMPLE_SUBMISSIONS: SubmissionRequest[] = [
  {
    ...
    applicantName: 'Muhammad Rizky Pratama',
    applicantEmail: 'rizky.pratama@gmail.com',
    applicantPhone: '081255544332',
    applicantRole: 'siswa',
    formData: {
      ...
      keperluan: 'Persyaratan Pengajuan Tunjangan Gaji PNS Orang Tua',
    ...
    timeline: [
      {
        ...
        actor: 'Siswa (Sistem)',
        note: 'Pengajuan permohonan berhasil dikirim oleh pemohon.',
      },
      {
        status: 'Diproses',
        timestamp: '2026-08-05T09:15:00Z',
        actor: 'Budi Santoso (Staf TU)',
        note: 'Dokumen dan data NIS/NISN telah diverifikasi cocok dengan Dapodik.',
      },
      {
        status: 'Selesai',
  ...
  },
  {
    ...
    applicantName: 'Anisa Nur Aini',
    applicantEmail: 'anisa.alumni@yahoo.com',
    applicantPhone: '085799887766',
    ...
    timeline: [
      {
        ...
        actor: 'Alumni (Sistem)',
        note: 'Pengajuan surat alumni diterima.',
      },
      {
        status: 'Diproses',
  ...
  },
  {
    ...
    applicantEmail: 'dewilestari@outlook.com',
    applicantPhone: '082133445566',
    applicantRole: 'siswa',
    formData: {
      nama: 'Dewi Lestari',
      nis: '20241088 / 0078877665',
  ...
  },
  {
    ...
    letterTypeId: 'lt-1',
    letterTypeName: 'Surat Keterangan Aktif Sekolah',
    applicantName: 'Bagas Aditya',
    applicantEmail: 'bagas.aditya@gmail.com',
    applicantPhone: '081377889900',
    applicantRole: 'siswa',
    formData: {
      nama: 'Bagas Aditya',
      nis: '20239900',
      ...
      keperluan: 'Permohonan Pembukaan Rekening Bank Pelajar',
      nama_ortu: 'Suhartono',
    },
    status: 'Ditolak',
    rejectionReason: 'Data NIS/NISN tidak ditemukan di database siswa aktif. Harap konfirmasi ke Wali Kelas terlebih dahulu.',
    timeline: [
      {
        status: 'Menunggu',
        timestamp: '2026-08-04T10:00:00Z',
        actor: 'Siswa (Sistem)',
        note: 'Pengajuan terkirim.',
      },
      {
        status: 'Ditolak',
        timestamp: '2026-08-04T11:30:00Z',
        actor: 'Budi Santoso (Staf TU)',
        note: 'Ditolak karena NIS/NISN belum valid di Dapodik.',
      },
    ],
